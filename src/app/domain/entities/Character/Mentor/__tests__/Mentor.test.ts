...
import { CharacterEnum, GenderEnum, KnowledgeTypeEnum, MentorTypeEnum } from '../../../../../../constants/character.enum';
import { SHORT_VALUE_MAX_LENGTH } from '../../../../../../frontend/constants';
import { MentorDTO } from '../../../../../../types/entities/character';
import { Mentor } from '../Mentor';

describe('WHEN "Mentor" instance was created', () => {
  const testCharacter = new Mentor();

  const characterDto: MentorDTO = {
    age: 10,
    ...
    mentorType: MentorTypeEnum.Dark,
    knowledgeType: KnowledgeTypeEnum.Education,
  };
  ...
  describe('AND "validate" was called', () => {
    it.each([
      ...
      ['mentorType', { ...characterDto, mentorType: undefined }],
      ['knowledgeType', { ...characterDto, knowledgeType: undefined }],
